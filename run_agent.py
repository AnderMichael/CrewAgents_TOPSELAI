...
# Task 1: Summarize Chapter 5
summarize_chapter5_task = Task(
    description=(
        "Read and summarize everything about chapter 5 'Matemáticas' from the PDF. "
        "Provide a concise summary highlighting the key functions and concepts."
    ),
    expected_output=(
        "A concise summary of chapter 5 'Matemáticas', highlighting key functions and concepts "
...
generate_fastapi_app_task = Task(
    description=(
        "Generate a FastAPI app in one file, given the code planning and explanations in analysis.md. Don't forget the run code to start the app."
        "Implement all the functions of chapter 5."
    ),
    expected_output=(
